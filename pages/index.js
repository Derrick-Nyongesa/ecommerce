                  ...
                  <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                    <div>
                      ...
                      <p className="mt-4 text-lg text-gray-300">
                        Welcome to JSM Headphones online store. We are known
                        mostly for a reputation of providing original headphones
                        at the most affordable prices any other dealer offers in
                        the market, with a promise of durability, quality and
                        authenticity.
                      </p>
                      <hr></hr>
                  ...
                  >
                    <div className="md:pr-12">
                      ...
                      <p className="mt-4 text-lg leading-relaxed">
                        JSM Headphones was established to participate in the
                        growing demand for e-commerce and with the aim of
